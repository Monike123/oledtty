 ...
 * font5x7.c
 * ---------
 * Adafruit GFX classic 5x7 font (glcdfont.c), column-major.
 *   glyph[5] = { col0..col4 }
 *   bit 0 = top row, bit 6 = bottom row (7 pixels tall).
 *
 * Source: Adafruit-GFX-Library (BSD license).
 */

#include "font5x7.h"

static const u8 glyph_data[95][5] = {
    ...
    /* 0x32 '2' */ {0x72, 0x49, 0x49, 0x49, 0x46},
    /* 0x33 '3' */ {0x21, 0x41, 0x49, 0x4D, 0x33},
    /* 0x34 '4' */ {0x18, 0x14, 0x12, 0x7F, 0x10},
    /* 0x35 '5' */ {0x27, 0x45, 0x45, 0x45, 0x39},
    /* 0x36 '6' */ {0x3C, 0x4A, 0x49, 0x49, 0x31},
    /* 0x37 '7' */ {0x41, 0x21, 0x11, 0x09, 0x07},
    /* 0x38 '8' */ {0x36, 0x49, 0x49, 0x49, 0x36},
    /* 0x39 '9' */ {0x46, 0x49, 0x49, 0x29, 0x1E},
    ...
    /* 0x41 'A' */ {0x7C, 0x12, 0x11, 0x12, 0x7C},
    ...
    /* 0x47 'G' */ {0x3E, 0x41, 0x41, 0x51, 0x73},
    ...
    /* 0x4D 'M' */ {0x7F, 0x02, 0x1C, 0x02, 0x7F},
    ...
    /* 0x5A 'Z' */ {0x61, 0x59, 0x49, 0x4D, 0x43},
    /* 0x5B '[' */ {0x00, 0x7F, 0x41, 0x41, 0x41},
    /* 0x5C '\\' */ {0x02, 0x04, 0x08, 0x10, 0x20},
    /* 0x5D ']' */ {0x00, 0x41, 0x41, 0x41, 0x7F},
    /* 0x5E '^' */ {0x04, 0x02, 0x01, 0x02, 0x04},
    /* 0x5F '_' */ {0x40, 0x40, 0x40, 0x40, 0x40},
    /* 0x60 '`' */ {0x00, 0x03, 0x07, 0x08, 0x00},
    /* 0x61 'a' */ {0x20, 0x54, 0x54, 0x78, 0x40},
    /* 0x62 'b' */ {0x7F, 0x28, 0x44, 0x44, 0x38},
    /* 0x63 'c' */ {0x38, 0x44, 0x44, 0x44, 0x28},
    /* 0x64 'd' */ {0x38, 0x44, 0x44, 0x28, 0x7F},
    /* 0x65 'e' */ {0x38, 0x54, 0x54, 0x54, 0x18},
    /* 0x66 'f' */ {0x00, 0x08, 0x7E, 0x09, 0x02},
    /* 0x67 'g' */ {0x18, 0xA4, 0xA4, 0x9C, 0x78},
    /* 0x68 'h' */ {0x7F, 0x08, 0x04, 0x04, 0x78},
    /* 0x69 'i' */ {0x00, 0x44, 0x7D, 0x40, 0x00},
    /* 0x6A 'j' */ {0x20, 0x40, 0x40, 0x3D, 0x00},
    /* 0x6B 'k' */ {0x7F, 0x10, 0x28, 0x44, 0x00},
    /* 0x6C 'l' */ {0x00, 0x41, 0x7F, 0x40, 0x00},
    /* 0x6D 'm' */ {0x7C, 0x04, 0x78, 0x04, 0x78},
    /* 0x6E 'n' */ {0x7C, 0x08, 0x04, 0x04, 0x78},
    /* 0x6F 'o' */ {0x38, 0x44, 0x44, 0x44, 0x38},
    /* 0x70 'p' */ {0xFC, 0x18, 0x24, 0x24, 0x18},
    /* 0x71 'q' */ {0x18, 0x24, 0x24, 0x18, 0xFC},
    /* 0x72 'r' */ {0x7C, 0x08, 0x04, 0x04, 0x08},
    /* 0x73 's' */ {0x48, 0x54, 0x54, 0x54, 0x24},
    /* 0x74 't' */ {0x04, 0x04, 0x3F, 0x44, 0x24},
    ...
    /* 0x79 'y' */ {0x4C, 0x90, 0x90, 0x90, 0x7C},
...
const u8 *font5x7_lookup(char ch) {
    if (ch < 0x20 || ch > 0x7E) {
        return glyph_data[0];
    }
    return glyph_data[(unsigned char)ch - 0x20];
}
